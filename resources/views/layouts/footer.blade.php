                                    ...
                                    <form action="#">
                                        <div class="product-add-to-cart mb-2">
                                            ...
                                            <div class="box-quantity d-flex gap-2">
                                                <input class="quantity form-control" min="1" value="1" type="number">
                                                <a class="add-cart btn btn-primary" data-id="{{ $product->id }}" href="#"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
