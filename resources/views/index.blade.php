                    ...
                    <div class="block_content owl-carousel">
                        ...
                        <div class="list-categories">
                            <div class="box-inner">
                                ...
                                <div class="desc-listcategoreis">
                                    <h3 class="name_categories"><a href="{{route('productDetails')}}">Health & Beauty</a></h3>
                                    <p class="description-list">Praesent volutpat ut nisl in hendrerit. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia</p>
                                    <div class="listcate_shop_now">
                                        <a href="{{route('cart')}}">Shop Now</a>
                                    </div>
                ...
                <div class="row g-0">
                    <div class="col-md-6">
                        <div class="banner-box m-0">
                            <a href="{{route('shop')}}"><img src="{{asset('assets/images/banner/1_1.webp')}}" alt="harosa"></a>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="banner-box m-0">
                            <a href="{{route('shop')}}"><img src="{{asset('assets/images/banner/2_1.webp')}}" alt="harosa"></a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="productTabContent0 owl-carousel">
                                    ...
                                    <div class="item-product">
                                        ...
                                        <div class="product-miniature js-product-miniature">
                                            <div class="img_block">
                                                <a href="{{route('productDetails')}}" class="thumbnail product-thumbnail">
                                                    <img src="{{asset('assets/images/product/11.webp')}}" alt="harosa product">
                                                </a>
                                                <ul class="product-flag">
                                                    <li class="new"><span>New</span></li>
                                                </ul>
                                    ...
                                    <div class="item-product">
                                        ...
                                        <div class="product-miniature js-product-miniature">
                                            <div class="img_block">
                                                <a href="{{route('productDetails')}}" class="thumbnail product-thumbnail">
                                                    <img src="{{asset('assets/images/product/12.webp')}}" alt="harosa product">
                                                </a>
                                                <ul class="product-flag">
                                                    <li class="new"><span>New</span></li>
                                                </ul>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="item-static">
                            <div class="banner-box"><a href="#"> <img src="{{asset('assets/images/product/3_1.webp')}}" alt="" class="img-responsive"></a></div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="item-static">
                            <div class="banner-box"><a href="#"> <img src="{{asset('assets/images/product/4_1.webp')}}" alt="" class="img-responsive"></a></div>
                            <div class="content-static">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="item-static">
                            <div class="banner-box"><a href="#"> <img src="{{asset('assets/images/product/5_1.webp')}}" alt="" class="img-responsive"></a></div>
                            <div class="content-static">
                        ...
                        <div class="item-testimonials">
                            <div class="item">
                                <div class="content_author">
                                    <img src="{{asset('assets/images/testimonials/sample1.webp')}}" alt="Harosa Testimonial">
